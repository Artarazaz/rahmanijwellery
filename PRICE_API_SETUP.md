...
این پروژه برای قیمت زنده‌ی بازار ایران از یک provider سمت سرور استفاده می‌کند. مقدارها در مرورگر hard-code نشده‌اند و API هر ۵ ثانیه بررسی می‌شود تا قیمت‌ها سریع‌تر تازه شوند.
